'*****************************************************************************************************************'
#How to conduct a basic metaanalysis using the meta package.
...
#Build dateset "dataset"

Author <-c("Author1", "Author2", "Author3", "Author4","Author5", "Author6", "Author7", "Author8", "Author9", "Author10")
...
#Publicationbias assessment by funnelplot and a linear regression test
